...
tinypdf is a simple library for generating PDF document written in Go lang.
...
```
go get -u github.com/cdvelop/tinypdf
```
...
func main() {
	...
	pdf := tinypdf.GoPdf{}
	pdf.Start(tinypdf.Config{
		PageSize: *tinypdf.PageSizeA4,
		Protection: tinypdf.PDFProtectionConfig{
			UseProtection: true,
			Permissions: tinypdf.PermissionsPrint | tinypdf.PermissionsCopy | tinypdf.PermissionsModify,
...
Import existing PDF power by package [gofpdi](https://github.com/cdvelop/tinypdf/gofpdi) created by @phpdave11 (thank you :smile:)
...
func main() {
    ...
    pdf.Start(tinypdf.Config{
        PageSize: *tinypdf.PageSizeA4,
        TrimBox: tinypdf.Box{Left: mm6ToPx, Top: mm6ToPx, Right: tinypdf.PageSizeA4.W - mm6ToPx, Bottom: tinypdf.PageSizeA4.H - mm6ToPx},
    })

    // Page trim-box
    opt := tinypdf.PageOption{
        PageSize: *tinypdf.PageSizeA4,
        TrimBox: &tinypdf.Box{Left: mm6ToPx, Top: mm6ToPx, Right: tinypdf.PageSizeA4.W - mm6ToPx, Bottom: tinypdf.PageSizeA4.H - mm6ToPx},
    }
