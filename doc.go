...
tinypdf has no dependencies other than the Go standard library. All tests
pass on Linux, Mac and Windows platforms.

tinypdf supports UTF-8 TrueType fonts and “right-to-left” languages. Note
...
duration. But it is hoped that tinypdf has a bright future in the open
source world. Due to Go’s promise of compatibility, tinypdf should
...
example PDFs. These can be found in the tinypdf/pdf directory after the
tests complete.
...
the tinypdf/pdf/reference directory and if the third argument to
...
generate output in different forms. It uses tinypdf for its document
production mode.

# Contributing Changes

tinypdf is a global community effort and you are invited to make it even
...
that does not directly pertain to the core functionality of tinypdf
...
tinypdf is released under the MIT License. It is copyrighted by Kurt Jung
...
independently of tinypdf. Paul also added support for page boxes used in
