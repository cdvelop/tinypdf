...
Package `go-pdf/docpdf` implements a PDF document generator with high level support for
...
`go-pdf/docpdf` has no dependencies other than the Go standard library. All tests pass
on Linux, Mac and Windows platforms.

`go-pdf/docpdf` supports UTF-8 TrueType fonts and "right-to-left" languages. Note that
...
```shell
go get github.com/tinywasm/docpdf
```

Later, to receive updates, run

```shell
go get -u -v github.com/tinywasm/docpdf/...
```
...
See the functions in the [fpdf_test.go][docpdf-test] file (shown as examples in
...
[FPDF][docpdf-site] library written in PHP (despite the caveat in the
...
example PDFs. These can be found in the go-pdf/docpdf/pdf directory after the tests
complete.
...
[fpdf_test.go][docpdf-test] for some helper routines, for example
...
with the same name as the example PDF is placed in the go-pdf/docpdf/pdf/reference
...
can generate output in different forms. It uses go-pdf/docpdf for its document
production mode.

## Contributing Changes

`go-pdf/docpdf` is a global community effort and you are invited to make it even better.
...
This package's code and documentation are closely derived from the [FPDF][docpdf-site]
...
[badge-report]: https://goreportcard.com/badge/github.com/tinywasm/docpdf
...
[docpdf-test]: https://github.com/tinywasm/docpdf/blob/master/fpdf_test.go
[gfont]: https://fonts.google.com/
[github]: https://github.com/tinywasm/docpdf
[godoc]: https://godoc.org/github.com/tinywasm/docpdf
[issue109]: https://github.com/phpdave11/gofpdf/issues/109
[jung]: https://github.com/phpdave11/
[last-commit]: https://github.com/tinywasm/docpdf/commit/603f56990463f011cb1dbb64ef7f872c1adc009a
[license]: https://raw.githubusercontent.com/go-pdf/docpdf/master/LICENSE
[lint]: https://github.com/golang/lint
[logo]: https://github.com/tinywasm/docpdf/raw/master/image/logo_gofpdf.jpg
[noto]: https://github.com/jsntn/webfonts/blob/master/NotoSansSC-Regular.ttf
[pr]: https://help.github.com/articles/using-pull-requests/
[report]: https://goreportcard.com/report/github.com/tinywasm/docpdf
[status]: https://travis-ci.org/go-pdf/docpdf
[test]: https://github.com/tinywasm/docpdf/blob/master/fpdf_test.go
