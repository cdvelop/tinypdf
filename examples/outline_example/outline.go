...
func GetFont(pdf *tinypdf.GoPdf, fontPath string) (err error) {
...
func OutlineWithLevelExample() (err error) {
	...
	*/
	...
	// outline nodes
	var outlineNodes tinypdf.OutlineNodes
	var first = new(tinypdf.OutlineNode)
	var second = new(tinypdf.OutlineNode)
	var third = new(tinypdf.OutlineNode)
	var nodeObjs = make([]*tinypdf.OutlineNode, 0)
	...
	var node21 = new(tinypdf.OutlineNode)
	node21.Obj = lv21
	...
	var node22 = new(tinypdf.OutlineNode)
	node22.Obj = lv22
	...
	var node31 = new(tinypdf.OutlineNode)
	node31.Obj = lv31
	...
	var node32 = new(tinypdf.OutlineNode)
	node32.Obj = lv32
