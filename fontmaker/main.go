...
import (
	...
	"github.com/cdvelop/tinypdf/fontmaker/core"
	//"runtime/debug"
)
...
func echoUsage() {
	...
	buff.WriteString("fontmaker is tool for making font file to use with tinypdf.\n")
	buff.WriteString("\nUsage:\n")
	buff.WriteString("\tfontmaker encoding map_folder font_file output_folder\n")
	buff.WriteString("\nExample:\n")
	buff.WriteString("\tfontmaker cp874 /gopath/github.com/cdvelop/tinypdf/fontmaker/map  ../ttf/Loma.ttf ./tmp\n")
	buff.WriteString("\n")
