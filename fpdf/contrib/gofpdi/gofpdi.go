/*
Package gofpdi wraps the gofpdi PDF library to import existing PDFs as templates. See github.com/cdvelop/docpdf/gofpdi
...
import (
	...
	realgofpdi "github.com/cdvelop/tinypdf/fpdf/contrib/gofpdi"
)
