...
func ExampleFpdf_HTMLBasicNew() {
	...
	pdf.Image(example.ImageFile("logo.png"), 10, 12, 30, 0, false, "", 0, "http://www.docpdf.org")
	...
	htmlStr := `You can now easily print text mixing different styles: <b>bold</b>, ` +
		...
		`<a href="http://www.docpdf.org">www.docpdf.org</a>, or on an image: click on the logo.`
...
func ExampleFpdf_CellFormat_codepageescape() {
	...
	pdf.AddPage()
	htmlStr := `Until go-pdf/docpdf supports UTF-8 encoded source text, source text needs ` +
...
func ExampleFpdf_CellFormat_codepage() {
	...
	pdf.AddPage()
	str := `Go-pdf/docpdf provides a translator that will convert any UTF-8 code point ` +
...
func ExampleFpdf_RegisterImageReader() {
	...
	const (
		...
		ht       = 297
		fontSize = 15
		urlStr   = "https://github.com/cdvelop/docpdf/raw/main/image/gofpdf.png"
...
// Adapted from http://www.docpdf.org/en/script/script61.php
